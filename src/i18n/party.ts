...
const en = {
  ...
  choosePlate: 'Choose the plate that feels most like you.', selected: 'Selected', notSelected: 'Not selected', registryBody: 'If you would like to bring a gift, the hosts have shared their registry.', viewRegistry: 'View registry', songHelp: 'Share the song you hope finds you on the dance floor.', saveSong: 'Save song',
  arrival: 'Arrival & welcome', ceremony: 'Celebration begins', dinner: 'Dinner', dancing: 'Dancing & dessert', guest: 'guest',
} as const;
...
const ar: Record<PartyInvitationKey, string> = {
  ...
  choosePlate: 'اختر الطبق الذي يناسبك وسنتولى الباقي.', selected: 'المحدد', notSelected: 'لم يُحدد', registryBody: 'إن رغبت بإحضار هدية، فقد شارك المضيفون قائمة الهدايا.', viewRegistry: 'عرض القائمة', songHelp: 'شارك الأغنية التي تتمنى سماعها في المناسبة.', saveSong: 'حفظ الأغنية',
  arrival: 'الوصول والترحيب', ceremony: 'بداية الاحتفال', dinner: 'العشاء', dancing: 'الرقص والحلوى', guest: 'ضيف',
};
