...
const en = {
  invitation: 'Invitation', guestName: 'Your name', continue: 'Continue', privateInvitation: 'A private invitation for', reception: 'Reception', dinner: 'Dinner', viewLocation: 'View location', confirmAttendance: 'Confirm attendance', editResponse: 'Edit response',
...
const ar: Record<InvitationKey, string> = {
  invitation: 'دعوة', guestName: 'اسمك', continue: 'متابعة', privateInvitation: 'دعوة خاصة إلى', reception: 'الاستقبال', dinner: 'العشاء', viewLocation: 'عرض الموقع', confirmAttendance: 'تأكيد الحضور', editResponse: 'تعديل الرد',
