...
const en = {
  ...
  localGuestData: 'Guest, RSVP, and check-in data is stored locally in this browser.', searchGuests: 'Search guests', allResponses: 'All responses', notOpened: 'Not opened', openedNoRsvp: 'Opened — No RSVP', openedCount: 'Opened', addGuest: 'Add guest', tag: 'Tag', noGuests: 'No local guests for this project yet.', missingPhone: 'No phone', copyLink: 'Copy link', linkCopied: 'Link copied', openInvitation: 'Open invitation',
...
const ar: Record<AppTranslationKey, string> = {
  ...
  operationName: 'الاسم', namePlaceholder: 'اسم الزفاف أو التصميم', currentWedding: 'الزفاف الحالي', createWedding: 'إنشاء زفاف', createEvent: 'إنشاء مناسبة', newWedding: 'زفاف جديد', newParty: 'حفلة جديدة', archive: 'أرشفة', eventStatus: 'الحالة', saveNow: 'احفظ الآن', rename: 'إعادة تسمية', duplicate: 'تكرار', copy: 'نسخة', delete: 'حذف', confirmDelete: 'تأكيد الحذف', cancel: 'إلغاء', saved: 'تم الحفظ', saving: 'جارٍ الحفظ…', saveError: 'خطأ في الحفظ', savedDesigns: 'التصاميم المحفوظة — المظهر فقط', chooseDesign: 'اختر تصميماً محفوظاً', saveAppearance: 'حفظ المظهر', apply: 'تطبيق', design: 'تصميم',
  ...
  localGuestData: 'تُحفظ بيانات الضيوف والردود وتسجيل الدخول محلياً في هذا المتصفح.', searchGuests: 'البحث عن ضيف', allResponses: 'كل الردود', notOpened: 'لم تُفتح', openedNoRsvp: 'فُتحت بلا رد', openedCount: 'مرات الفتح', addGuest: 'إضافة ضيف', tag: 'وسم', noGuests: 'لا يوجد ضيوف محليون لهذه المناسبة بعد.', missingPhone: 'لا يوجد هاتف', copyLink: 'نسخ الرابط', linkCopied: 'تم نسخ الرابط', openInvitation: 'فتح الدعوة',
